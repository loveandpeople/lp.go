...
func ExampleSubseed() {
	...
	subseed, err := signing.Subseed(seed, 0, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
...
func ExampleKey() {
	...
	key, err := signing.Key(subseedTrits, consts.SecurityLevelLow, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
...
func ExampleDigests() {
	...
	digests, err := signing.Digests(keyTrits, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
...
func ExampleAddress() {
	...
	address, err := signing.Address(digestsTrits, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
...
func ExampleSignatureFragment() {
	...
	sigFragment, err := signing.SignatureFragment(hashSignatureTrits, keyTrits, 0, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
...
func ExampleDigest() {
	...
	digest, err := signing.Digest(hashSignatureTrits, sigFragmentTrits, 0, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
...
func ExampleValidateSignatures() {
	...
	valid, err := signing.ValidateSignatures(address, sigFragment, hashSignature, curl.NewCurlP81())
	if err != nil {
		// handle error
		return
	}
